...
//                           icon: Icon(CupertinoIcons.device_phone_portrait, size: 30, color: Colors.white,)
//                         ),
...
//                           status: 'Connected',
//                           statusColor: Colors.red,
//                           icon: Icon(CupertinoIcons.person, size: 30, color: Colors.white,)
...
//     Widget? icon, // Nuevo parámetro para el icono
//     bool showCheck = false, // Nuevo parámetro para mostrar check derecho
//   }) {
//     return InkWell(
//       onTap: () {
//         // Aquí puedes agregar la lógica cuando se haga click
//         print('$label clicked');
//         // Por ejemplo: Navigator.push, mostrar dialog, etc.
//       },
...
//         child: Row(
//           children: [
//             // Icono recibido por parámetro (reemplaza al checkbox)
...
//               ),
//             ),
//             // Check al lado derecho (si showCheck es true)
//             if (showCheck)
...
class _SetupScreenState extends State<SetupScreen> {
  ...
  final SpikeService _spikeService = SpikeService();
  ...
  Future<void> _checkUserData() async {
    try {
      ...
      final device = await _spikeService.getSavedDevice();
                      ...
                      child: Column(
                        children: [
                          ...
                          _buildClickableItem(
                            ...
                            statusColor: _hasProfile ? Colors.green : Colors.red,
                            icon: Icon(
